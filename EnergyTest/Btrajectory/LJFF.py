...
from MMTK_LJ import LJTerm

class LJForceField(ForceField):
    ...
    def __init__(self, atom1, atom2, type1, type2):
        ...
        self.arguments = (self.atom_index1, self.atom_index2, self.type_1, self.type_2)
        # Initialize the ForceField class, giving a name to this one.
        ForceField.__init__(self, 'LJ')
...
#                                       self.atom1,self.atom2)]
    ...
    def description(self):
        return "LJFF.LJForceField" + `self.arguments`
