...
ext_modules=[
    Extension('H20Rigid3DRotor_PINormalModeIntegrator',
              ['./H20Rigid3DRotor_PINormalModeIntegrator.pyx' ],
              extra_compile_args = compile_args,
              include_dirs= include_dirs,
              libraries= libraries+ ['fftw3'],
              define_macros = macros)
#    Extension('MMTK_COM_PINormalModeIntegrator',
#              ['./MMTK_COM_PINormalModeIntegrator.pyx'],
#              extra_compile_args = compile_args,
#              include_dirs=include_dirs,
#              library_dirs=library_dirs,
#              libraries=libraries+ ['fftw3'],
#              define_macros=macros),
#    Extension('RigidRotor_PINormalModeIntegrator',
#              ['./RigidRotor_PINormalModeIntegrator.pyx'],
#              extra_compile_args = compile_args,
#              include_dirs=include_dirs,
#              library_dirs=library_dirs,
#              libraries=libraries+ ['fftw3'],
#              define_macros=macros),
#    Extension('RotOnly_PINormalModeIntegrator',
#              ['./RotOnly_PINormalModeIntegrator.pyx'],
#              extra_compile_args = compile_args,
#              include_dirs=include_dirs,
#              library_dirs=library_dirs,
#              libraries=libraries+ ['fftw3'],
#              define_macros=macros),
#    Extension('RotOnly_PINormalModeIntegrator_NoPot',
#              ['./RotOnly_PINormalModeIntegrator_NoPot.pyx'],
#              extra_compile_args = compile_args,
#              include_dirs=include_dirs,
#              library_dirs=library_dirs,
#              libraries=libraries+ ['fftw3'],
